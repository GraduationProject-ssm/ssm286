...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1gn8XeNE2J?p=83)
...
随着计算机技术的发展以及计算机网络的逐渐普及，互联网成为人们查找信息的重要场所，二十一世纪是信息的时代，所以信息的交换和信息流通显得特别重要。因此，开发合适的电脑公司财务管理系统成为企业必然要走的一步棋。开发合适的电脑公司财务管理系统，可以方便管理人员对电脑公司财务管理系统的管理，提高信息管理工作效率及查询效率，有利于更好的为用户提供服务。

1.2研究目的

随着互联网技术的快速发展，网络时代的到来，网络信息也将会改变当今社会。各行各业在日常企业经营管理等方面也在慢慢的向规范化和网络化趋势汇合。电脑公司财务管理系统的信息化程度体现在将互联网与信息技术应用于经营与管理，以现代化工具代替传统手工作业。无疑，使用网络信息化管理使信息管理更先进、更高效、更科学，信息交流更迅速。

企业如果还用之前的只有线下卖东西，已经很落伍了，这样会导致了效率低下。而且，时间一长的话，积累下来的数据信息不容易保存，对于查询、更新还有维护会带来不少问题。对于数据交接也存在很大的隐患。如果采用电子化的存储方式就会带来很大的改善，而且给用户的查询带来了很大便利，因此设计一个电脑公司财务管理系统刻不容缓，能够提高企业在信息技术方面的展示水平。
## 1.3系统设计思想
...
# 3系统分析
## 3.1可行性分析
通过对本电脑公司财务管理系统实行的目的初步调查和分析，提出可行性方案并对其一一进行论证。我们在这里主要从技术可行性、经济可行性、操作可行性等方面进行分析。
### 3.1.1技术可行性
本电脑公司财务管理系统采用JAVA作为开发语言，Spring Boot框架，是基于WEB平台的B/S架构系统。
...
因此，电脑公司财务管理系统在开发技术上具有很高可行性，且开发人员掌握了一定的开发技术，所以此系统的开发技术具有可行性。
### 3.1.2经济可行性
本电脑公司财务管理系统采用的软件都是开源的，这样能够削减很多的精力和资源，降低开发成本。同时对计算机的配置要求也极低，即使是淘汰下来的计算机也能够满足需要，因此，本系统在经济上是完全具有可行性的，所以在经济上是十分可行的。
### 3.1.3操作可行性
本电脑公司财务管理系统的界面简单易操作，用户只要平时有在用过电脑，都能进行访问和操作。本系统具有易操作、易管理、交互性好的特点，在操作上是非常简单的，因此在操作上具有很高的可行性。

综上所述，此系统开发目标已明确，在技术、经济和操作方面都具有很高的可行性，并且投入少、功能完善、管理方便，因此系统的开发是完全可行的。
## 3.2系统性能分析
### 3.2.1 系统安全性
此电脑公司财务管理系统要严格控制管理权限，具体要求如下：

（1）要想对电脑公司财务管理系统进行管理，首先要依靠用户名和密码在系统中登陆，无权限的用户不可以通过任何方式登录系统和对系统的任何信息和数据进行查看，这样可以保证系统的安全可靠性和准确性。
...
图4.14 部门分类实体属性图
### 4.3.2数据库设计表
电脑公司财务管理系统需要后台数据库，下面介绍数据库中的各个表的详细信息：
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|chengbenmingcheng|varchar(200)|是|NULL|成本名称|
|shouruxiangmu|longtext|是|NULL|收入项目|
|shourujine|int(11)|是|NULL|收入金额|
|zhichuxiangmu|longtext|是|NULL|支出项目|
|zhichujine|int(11)|是|NULL|支出金额|
|jieyujine|varchar(200)|是|NULL|结余金额|
|riqi|date|是|NULL|日期|
表4.3 发票信息
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|fapiaobianhao|varchar(200)|是|NULL|发票编号|
|kehuxingming|varchar(200)|是|NULL|客户姓名|
|shangpinmingcheng|varchar(200)|是|NULL|商品名称|
|shangpindanjia|int(11)|是|NULL|商品单价|
|shangpinshuliang|int(11)|是|NULL|商品数量|
|zongjine|varchar(200)|是|NULL|总金额|
|kaipiaoriqi|date|是|NULL|开票日期|
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|gongyingshangxingming|varchar(200)|是|NULL|供应商姓名|
|gongsimingcheng|varchar(200)|是|NULL|公司名称|
|gongsidizhi|varchar(200)|是|NULL|公司地址|
|gongyingchanpin|varchar(200)|是|NULL|供应产品|
|lianxidianhua|varchar(200)|是|NULL|联系电话|
|hezuoshizhang|varchar(200)|是|NULL|合作时长|
|beizhu|longtext|是|NULL|备注|
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|pingzhengbianhao|varchar(200)|是|NULL|凭证编号|
|pingzhengmingcheng|varchar(200)|是|NULL|凭证名称|
|leixing|varchar(200)|是|NULL|类型|
|pingzhengneirong|longtext|是|NULL|凭证内容|
...
|gongsimingcheng|varchar(200)|是|NULL|公司名称|
|gongsidizhi|varchar(200)|是|NULL|公司地址|
|hezuoxiangmu|varchar(200)|是|NULL|合作项目|
|hezuoshizhang|varchar(200)|是|NULL|合作时长|
|lianxidianhua|varchar(200)|是|NULL|联系电话|
|beizhu|longtext|是|NULL|备注|
|dengjiriqi|date|是|NULL|登记日期|
...
|riqi|date|是|NULL|日期|
|zhaiyao|longtext|是|NULL|摘要|
|shouru|int(11)|是|NULL|收入|
|zhichu|int(11)|是|NULL|支出|
|jine|varchar(200)|是|NULL|金额|
|guanligonghao|varchar(200)|是|NULL|管理工号|
...
|shifouwanhao|varchar(200)|是|NULL|是否完好|
|dengjiriqi|datetime|是|NULL|登记日期|
表4.10 商品类型
...
|baoxiaojine|int(11)|是|NULL|报销金额|
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|guanligonghao|varchar(200)|否||管理工号|
|mima|varchar(200)|否||密码|
|guanlixingming|varchar(200)|是|NULL|管理姓名|
|xingbie|varchar(200)|是|NULL|性别|
...
|jiaokuanjine|int(11)|是|NULL|缴款金额|
|jiaokuanriqi|date|是|NULL|缴款日期|
|beizhu|longtext|是|NULL|备注|
|guanligonghao|varchar(200)|是|NULL|管理工号|
|guanlixingming|varchar(200)|是|NULL|管理姓名|
|sfsh|varchar(200)|是|否|是否审核|
...
|quanqinjiangli|int(11)|是|NULL|全勤奖励|
|jixiaojiangli|int(11)|是|NULL|绩效奖励|
|shebaobuzhu|int(11)|是|NULL|社保补助|
|koukuanjine|int(11)|是|NULL|扣款金额|
|koukuanshixiang|longtext|是|NULL|扣款事项|
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|zhipiaohao|varchar(200)|是|NULL|支票号|
|shoukuandanwei|varchar(200)|是|NULL|收款单位|
...
## 5.1 管理员模块的实现
### 5.1.1 员工管理
电脑公司财务管理系统的系统管理员可以管理员工信息，可以对员工信息进行添加，修改，删除操作。具体界面的展示如图5.1所示。

![](/md/blog.008.png)

图5.1 员工信息管理界面
### 5.1.2 部门分类管理
系统管理员可以管理部门分类信息，可以对部门分类信息进行添加，修改，删除查询操作，具体界面如图5.2所示。

![](/md/blog.009.png)图5.3 部门信息管理界面
### 5.1.3 记账凭证管理
系统管理员可以管理记账凭证品信息，对记账凭证信息进行添加，修改，删除操作。界面如下图所示：
...
## 5.2 员工模块的实现
### 5.2.1 员工薪酬
员工登录可以查看员工薪酬。界面如下图所示：

![](/md/blog.011.png)

图5.5 员工薪酬界面
### 5.2.2 商品库存
员工登录后可以对商品库存进行添加修改删除操作。界面如下图所示：
...
## 5.3 员工管理模块的实现
### 5.3.1 支票信息
员工管理登录后可以对支票信息信息添加修改删除操作。界面如下图所示：
...
### 5.3.2 日记账
员工管理可以登录对日记账进行操作。界面如下图所示：

![](/md/blog.014.png)

图5.8 日记账界面
### 5.3.3 发票信息
员工管理登录后可以对发票信息进行添加，修改，删除操作。界面如下图所示：
